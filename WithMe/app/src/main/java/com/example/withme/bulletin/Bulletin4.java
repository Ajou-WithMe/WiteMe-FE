...
public class Bulletin4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_bulletin4, container, false);
        ...
        TextView tv_guro = (TextView) rootView.findViewById(R.id.tv_guro);

        tv_guro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle bundle = new Bundle(); // 번들을 통해 값 전달
                bundle.putString("location",tv_guro.getText().toString());//번들에 넘길 값 저장
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                Bulletin3 bulletin3 = new Bulletin3();//프래그먼트2 선언
                bulletin3.setArguments(bundle);//번들을 프래그먼트2로 보낼 준비
                transaction.replace(R.id.fragment_container, bulletin3);
                transaction.commit();
            }
        });
